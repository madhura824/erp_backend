...
const updateCourseValidation = async (req, res, next) => {

    // console.log("update course val working")
    // next()
    try {
        ...
        console.log(error);
        res.status(500).json({ error: "Internal server error occurred in validating fields while updating a new course.", success: false });
    }
};
