...
const updateAluminiValidation = async (req, res, next) => {
//console.log("validations working")
    ...
    try {
        ...
        if (PRN == null || aluminiName == null || passoutYear == null || aluminiProgramme == null || favDomains == null || favSubjects == null ||
            details.jobTitle == null ||details.companyName == null ||details.totalYearsInCompany == null ||details.workingDomain == null || githubLink == null || linkedinLink == null  || phoneNo == null || aluminiEmail == null || about == null || image==null ) {
        ...
        }  else if (details.companyName.length < 5 || details.companyName.length > 50) {
        ...
        else if (details.totalYearsInCompany < 1 || details.totalYearsInCompany > 50) {
        ...
        console.log(error);
        res.status(500).json({ error: "Internal server error occurred while validating fields while updating the new alumini.", success: false });
    }
    
};

module.exports = updateAluminiValidation;
